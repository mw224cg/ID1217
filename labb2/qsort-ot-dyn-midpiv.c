...
-Dynamisk tröskel för att skapa tasks
...
int main(int argc, char* argv[]){
    ...
    {
    case 1:
        printf("Usage: ./QSOT-fyn-midpiv + 'number of cores' + 'array size'\n");
    ...
    task_threshold = arr_size / (num_threads * 25);
    ...
    printf("QSOT-DYN-MIDPIV: Average time: %f - Number of cores: %d\n", avg_time, num_threads);
    printf("Threshold: %d\n", task_threshold);
